...
| **08_Exp_TD-FLIM_Phasor_Analysis_MSSR_Mask.ipynb**       | **Advanced Experimental Analysis**: An advanced pipeline for analyzing 3-color GATTA-Cells with TD-FLIM. Includes MSSR-enhanced phasor segmentation, ROI-specific component analysis, quantitative cluster metrics, and PhasorPy 0.9 compatibility. |
